...
RSpec.describe "giving_backs/new", type: :view do
  before(:each) do
    assign(:giving_back, GivingBack.new(
      :user_id => "MyString",
  ...
  it "renders new giving_back form" do
    render

    assert_select "form[action=?][method=?]", giving_backs_path, "post" do
