...
logins = Login.create(username: 'cvdonley', password: 'password', email: 'cvdonley@noctrl.edu', created_at: DateTime.now, sign_in_count:0, updated_at: DateTime.now, first_name: 'Cornelius', last_name: 'Donley')
