...
login1 = Login.create(username: 'cvdonley', password: 'RonPaul2012', email: 'cvdonley@noctrl.edu', first_name: 'Cornelius', last_name: 'Donley', login_type: 2, middle_initial: 'VA')
...
degree9 = Degree.create(major_name: 'Life', degree_type: 4)
college9 = College.create(college_name: 'North Central College')
graduate_degree4 = GraduateDegree.create(user_id: user1.id, college_id: college9.id, degree_id: degree9.id, graduation_date: '2014-6-21', status: 0)

company2 = Company.create(company_name: 'RobCo')
login2 = Login.create(username: 'jduser', password: 'password', email: 'jjdoe@noctrl.edu', created_at: DateTime.now, sign_in_count: 0, updated_at: DateTime.now,first_name: "John", last_name: 'Doe', login_type: 0)
...
login3 = Login.create(username: 'gcuser', password: 'password', email: 'gcostanza@noctrl.edu', created_at: DateTime.now, sign_in_count: 0, updated_at: DateTime.now,first_name: "George", last_name: 'Costanza', login_type: 0)
...
login4 = Login.create(username: 'cwuser', password: 'password', email: 'cwinger@noctrl.edu', created_at: DateTime.now, sign_in_count: 0, updated_at: DateTime.now,first_name: "Christian", last_name: 'Winger', login_type: 0)
