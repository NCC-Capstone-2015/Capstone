...
password = 'password'
hashed_password = Login.new(:password => password).encrypted_password
logins = Login.create(username: 'cvdonley', encrypted_password: hashed_password, email: 'cvdonley@noctrl.edu', created_at: DateTime.now, sign_in_count:0, updated_at: DateTime.now, first_name: 'Cornelius', last_name: 'Donley')
...
login2 = Login.create(username: 'jduser', encrypted_password: hashed_password, email: 'jjdoe@noctrl.edu', created_at: DateTime.now, sign_in_count:0, updated_at: DateTime.now,first_name: "John", last_name: 'Doe', login_type: 0)
...
login3 = Login.create(username: 'gcuser', encrypted_password: hashed_password, email: 'gcostanza@noctrl.edu', created_at: DateTime.now, sign_in_count:0, updated_at: DateTime.now,first_name: "George", last_name: 'Costanza', login_type: 0)
...
login4 = Login.create(username: 'cwuser', encrypted_password: hashed_password, email: 'cwinger@noctrl.edu', created_at: DateTime.now, sign_in_count:0, updated_at: DateTime.now,first_name: "Christian", last_name: 'Winger', login_type: 0)
