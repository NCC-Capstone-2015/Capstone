...
graduate_degree4 = GraduateDegree.create(user_id: user1.id, college_id: college9.id, degree_id: degree9.id, graduateion_date: '2014-6-21', status: 1)
...
graduate_degree2 = GraduateDegree.create(user_id: user2.id, college_id: college3.id, degree_id: degree3.id, graduateion_date: '2016-12-21', status: 1)
...
graduate_degree4 = GraduateDegree.create(user_id: user3.id, college_id: college5.id, degree_id: degree5.id, graduateion_date: '2017-6-21', status: 1)
...
graduate_degree5 = GraduateDegree.create(user_id: user4.id, college_id: college7.id, degree_id: degree7.id, graduateion_date: '2014-6-21', status: 0)
degree8 = Degree.create(major_name: 'Mathematics', degree_type: 5)
graduate_degree5 = GraduateDegree.create(user_id: user4.id, college_id: college7.id, degree_id: degree8.id, graduateion_date: '2017-6-21', status: 1)
