...
ActiveRecord::Schema.define(version: 20150516161704) do
  ...
  add_index "account_logins", ["email"], name: "index_account_logins_on_email", unique: true, using: :btree
  add_index "account_logins", ["reset_password_token"], name: "index_account_logins_on_reset_password_token", unique: true, using: :btree
